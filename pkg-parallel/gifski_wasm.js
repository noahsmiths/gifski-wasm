...
* @returns {Uint8Array}
*/
export function encode(frames, num_of_frames, width, height, fps, frame_durations, quality, repeat, resize_width, resize_height, callback) {
    try {
