...
export declare function encode(options: EncodeOptions, memory?: WebAssembly.Memory): Promise<Uint8Array>;
export declare function getWrittenBytes(memory?: WebAssembly.Memory): Promise<number>;
