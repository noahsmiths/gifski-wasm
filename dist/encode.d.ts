...
export declare function _internal_encode(wasmEncodeFn: typeof gifskiEncode, { frames, width, height, fps, frameDurations, quality, repeat, resizeWidth, resizeHeight, progressCallback, }: EncodeOptions): Promise<Uint8Array>;
